...
SOURCE_REGISTRY: list[SourceDefinition] = [
    ...
    _source("Crossref", "research", "api", "https://api.crossref.org/works", enabled=True, reliability="high"),
    _source("Europe PMC", "research", "api", "https://www.ebi.ac.uk/europepmc/webservices/rest/search", enabled=True, reliability="high"),
    _source("PubMed", "research", "api", "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi", enabled=True, reliability="high"),
    _source("bioRxiv", "research", "api", "https://api.biorxiv.org/details/biorxiv", enabled=True, reliability="high"),
    _source("medRxiv", "research", "api", "https://api.biorxiv.org/details/medrxiv", enabled=True, reliability="high"),
    ...
    _source("Grants.gov", "finance", "api", "https://api.grants.gov/v1/api/search2", enabled=True, reliability="high"),
    _source("USAspending", "finance", "api", "https://api.usaspending.gov/api/v2/search/spending_by_award/", enabled=True, reliability="high"),
    ...
    _source("Common Crawl", "search", "api", "https://index.commoncrawl.org", enabled=True, reliability="high"),
    _source("GDELT", "news", "api", "https://api.gdeltproject.org/api/v2/doc/doc", enabled=True, reliability="high"),
    ...
    _source("F-Droid", "app_stores", "json", "https://f-droid.org/repo/index-v2.json", enabled=True),
    ...
    _source("Docker Hub", "code", "api", "https://hub.docker.com/v2/search/repositories/", enabled=True),
    _source("RubyGems", "code", "api", "https://rubygems.org/api/v1/search.json", enabled=True),
    ...
    _source("Greenhouse Jobs", "jobs", "api", "https://boards-api.greenhouse.io/v1/boards/{board}/jobs", enabled=True, reliability="high"),
    _source("Lever Jobs", "jobs", "api", "https://api.lever.co/v0/postings/{company}", enabled=True, reliability="high"),
]
